...
public class Settings {
	...
	//windows offset, the frame is bigger than the window for some reason
	//everything ive seen online seems to say it is a win 10 issue
	public static final int WINDOW_OFFSET = 14;
}
